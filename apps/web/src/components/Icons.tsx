...
export const TerminalAppIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="none">
    <rect x="2" y="4" width="28" height="24" rx="6" fill="currentColor" opacity="0.14" />
    <rect x="4" y="6" width="24" height="20" rx="4" stroke="currentColor" strokeWidth="2" />
    <path
      d="M9 12.5 13 16l-4 3.5M16.5 20H22"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
...
export const GhosttyIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 27 32" fill="none">
    <path
...
export const ITermIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 32 32" fill="none">
    <rect x="3" y="5" width="26" height="22" rx="5" fill="#0F172A" />
    <rect x="3" y="5" width="26" height="22" rx="5" stroke="currentColor" strokeWidth="1.5" />
    <circle cx="8" cy="10" r="1.25" fill="#EF4444" />
    <circle cx="12" cy="10" r="1.25" fill="#F59E0B" />
    <circle cx="16" cy="10" r="1.25" fill="#22C55E" />
    <path
      d="M9.5 15.5 13 18.5l-3.5 3M16 21.5h6.5"
      stroke="#E5E7EB"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
