...
const make = Effect.gen(function* () {
  ...
  const maybeGenerateAndRenameWorktreeBranchForFirstTurn = Effect.fn(
    ...
    yield* Effect.gen(function* () {
      ...
      const worktreeBranchPrefix = resolveWorktreeBranchPrefix(settings);
      if (
        !isTemporaryWorktreeBranch(oldBranch, worktreeBranchPrefix) &&
        !isTemporaryWorktreeBranch(oldBranch)
      ) {
        return;
      }
